...
image_no_1 = ImageTk.PhotoImage(Image.open("frames/frame0.jpg").resize((640,480)))
image_no_2 = ImageTk.PhotoImage(Image.open("frames/frame1.jpg").resize((640,480)))
image_no_3 = ImageTk.PhotoImage(Image.open("frames/frame2.jpg").resize((640,480)))
image_no_4 = ImageTk.PhotoImage(Image.open("frames/frame3.jpg").resize((640,480)))
